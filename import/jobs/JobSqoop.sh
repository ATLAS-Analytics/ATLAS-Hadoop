...
sqoop import --direct --connect "jdbc:oracle:thin:@//ADCR1-ADG-S.cern.ch:10121/ADCR.cern.ch" \
    ...
    -m 1 --as-avrodatafile --target-dir /atlas/analytics/panda/jobs/$3 \
