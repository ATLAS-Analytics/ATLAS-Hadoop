...
RECS = LOAD '/user/rucio01/nongrid_traces/2015-*.json'  using PigStorage as (Rec:chararray);
...
STORE D INTO 'tmp1.csv' USING org.apache.pig.piggybank.storage.CSVExcelStorage(',','NO_MULTILINE');
