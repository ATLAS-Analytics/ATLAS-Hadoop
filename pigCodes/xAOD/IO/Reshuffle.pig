...
D = foreach F generate line::ReadCalls as RC, line::ReadSize as RS, line::CacheSize as CS, SIZE(line::accessedFiles) as AF, SIZE(line::AccessedBranches) as AB, SIZE(line::AccessedContainers) as AC , line::fileType as FT ;
